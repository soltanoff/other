...
:bulb: Ключевые литералы и их особенности для математики бота:
  ...
  :small_blue_diamond: Подключена модульная арифметика: оператор \'mod\' - %
    Например: 7 по модулю 10 -> 7 % 10 = 7, -23 по модулю 31 -> -23 % 31 = 8
...
:book: Доступные функции:
  ...
  :small_orange_diamond: pow(Х, У) или X**Y - Х в степени У. Через pow реализуется извлечение корня любой степени: pow(27, 1/3.0) = 3.0
